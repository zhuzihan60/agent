...
_EXPECTED_SURFACE: dict[str, frozenset[str]] = {
    ...
    "capability-kubernetes": frozenset({"health", "describe", "capability_probe", "prepare", "apply", "undo", "verify", "reconcile"}),
    "capability-containers": frozenset({"health", "describe", "capability_probe", "prepare", "apply", "undo", "verify", "reconcile"}),
    "capability-disk": frozenset({"health", "describe", "capability_probe", "prepare", "apply", "undo", "verify", "reconcile"}),
...
_CLASS_NAMES: dict[str, str] = {
    ...
    "capability-containers": "ContainersPlugin",
    "capability-kubernetes": "KubernetesCapability",
    "capability-disk": "DiskPlugin",
...
def _wheel_consistency_errors() -> list[str]:
    ...
    with zipfile.ZipFile(wheel) as archive:
        ...
        for entrypoint_name in (
            ...
            "a4diag_builtin_plugins/capability_disk.py",
