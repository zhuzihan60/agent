...
""",
    ...
    (release / "VERSION").write_text("0.4.3\n", encoding="utf-8")
    for name in (
        "a4diag-0.4.3-py3-none-any.whl",
        "a4diag_builtin_plugins-0.4.3-py3-none-any.whl",
        "a4diag_target_runtime-0.4.3-py3-none-any.whl",
    ):
