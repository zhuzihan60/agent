...
""",
    ...
    (release / "VERSION").write_text("0.5.0\n", encoding="utf-8")
    for name in (
        "a4diag-0.5.0-py3-none-any.whl",
        "a4diag_builtin_plugins-0.5.0-py3-none-any.whl",
        "a4diag_target_runtime-0.5.0-py3-none-any.whl",
    ):
