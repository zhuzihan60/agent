...
class EvidenceSource(BaseModel):
    ...
    kind: Literal["service_state", "service_logs", "file", "probe", "container_state", "container_logs", "kubernetes_state", "kubernetes_evidence"]
    ...
    def validate_resource(self) -> EvidenceSource:
        ...
        elif self.kind in ("probe", "container_state", "container_logs", "kubernetes_state", "kubernetes_evidence"):
